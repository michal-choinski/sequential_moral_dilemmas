...
class PolynomialSchedule2(Schedule):
    def __init__(self,
                 schedule_timesteps,
                 final_p,
                 framework,
    ...
    def _value(self, t: Union[int, TensorType]):
        ...
        return tf.float32(self.final_p + (self.initial_p - self.final_p) * (
    ...
    def _tf_value_op(self, t: Union[int, TensorType]):
        ...
        return tf.cast(self.final_p + (self.initial_p - self.final_p) * (
            1.0 - (t / self.schedule_timesteps))**self.power, tf.float32)
